...
generate_allied_guard {
  ...
  writeini $char(%monster.name) basestats tp %base.hp.tp
  writeini $char(%monster.name) basestats str 26
  writeini $char(%monster.name) basestats def 34
  writeini $char(%monster.name) basestats int 38
  writeini $char(%monster.name) basestats spd 22
  ...
  writeini $char(%monster.name) techniques FastBlade $round($calc(%current.battlestreak / 2),0)
  writeini $char(%monster.name) techniques BurningBlade $round($calc(%current.battlestreak / 2),0)
  writeini $char(%monster.name) techniques DoublePunch $round($calc(%current.battlestreak / 2),0)
