...
character.hp.check { 
  ...
  if ($person_in_mech(1) = true) { 
    ...
    if ($2 = public) { $display.message($readini(translation.dat, system, ViewMyHP1), private) | $display.message($readini(translation.dat, system, ViewMyHP2), private) }
...
player.skills.list {
  ...
  if ($readini($char($1), skills, deathstrike.on) = on) { $skills_message_check(02Deathly Strike) }
  ...
  var %covertyp $readini($char(%cover.target), Monster, Type)
  if ((%cover.target != $null) && (%cover.target != none) && (%covertyp == $null)) { $skills_message_check(02Covered by %cover.target) }
  if ((%cover.target != $null) && (%cover.target != none) && (%covertyp != $null)) { $skills_message_check(02Defence Incresed by %cover.target) }
  unset %cover.target
}
...
readitems { 
  ...
  if (%items.empty != true) { 
    if ($2 = channel) { $display.message(03Other item commands:05 !misc items03 $+ $chr(44) 03!seals03 $+ $chr(44) 15!portals03 $+ $chr(44) 07!gems03 $+ $chr(44) 06!instruments03 $+ $chr(44) 14!keys03 $+ $chr(44) 06!trusts03 $+ $chr(44) 05!trading cards03 $+ $chr(44) 03!mech items  $+ $chr(44) 05!ingredients $+ $chr(44) 07!runes  $+ $chr(44) 10!ammo 11!tameitems,private) }
    if ($2 = private) {  $display.private.message(03Other item commands:05 !misc items03 $+ $chr(44) 03!seals03 $+ $chr(44) 15!portals03 $+ $chr(44) 07!gems03 $+ $chr(44) 06!instruments03 $+ $chr(44) 14!keys03 $+ $chr(44) 06!trusts03 $+ $chr(44) 05!trading cards03 $+ $chr(44) 03!mech items $+ $chr(44) 05!ingredients $+ $chr(44) 07!runes $+ $chr(44) 10!ammo $+  $chr(44)  11!tameitems) }
    if ($2 = dcc) { $dcc.private.message($nick, 03Other item commands:05 !misc items03 $+ $chr(44) 03!seals03 $+ $chr(44) 15!portals03 $+ $chr(44) 07!gems03 $+ $chr(44) 06!instruments03 $+ $chr(44) 14!keys03 $+ $chr(44) 06!trusts03 $+ $chr(44) 05!trading cards03 $+ $chr(44) 03!mech items $+ $chr(44) 05!ingredients $+ $chr(44) 07!runes $+ $chr(44) 10!ammo $+ $chr(44)  11!tameitems) }
  }
...
character.stat.levelup.check {
  ...
  if (%stat.xp = 10) { 
    ...
    writeini $char($1) BaseStats $2 %basestat
    msg #RPG-MC Congratulation $1 your $2 was increased by +1. Nice Work :)
  }
