...
ON 2:Chat:!death strike*: { $skill.deathstrike($nick) }
ON 2:Chat:!mightystrike*: { $skill.mightystrike($nick) }
ON 2:Chat:!deathstrike*: { §skill.deathstrike($nick) }
...
ON 50:Chat:!end bat*: { $endbattle($3) | unset %player.list | msg %battlechan Hallo } 
